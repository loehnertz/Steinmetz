...
data class EdgeAttributes(
    ...
    init {
        check(scoresAreLegal(this)) { "The edge attributes $this are not legal" }
    }
    ...
    companion object {
        ...
        private fun scoresAreLegal(edgeAttributes: EdgeAttributes): Boolean {
            ...
            if (edgeAttributes.staticCouplingScore < 0 || edgeAttributes.staticCouplingScore > 100) return false
